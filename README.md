# Week_3_Coding_Assignment
This will be the home of my week 3 coding assignment. 
Coding Steps:
...
a.	Use a loop to iterate through the array and calculate the average number of letters per name. Prdef/int the result to the console.
